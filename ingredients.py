...
class display(tk.Frame):
    ...
    def display_frame(self):
        ...
        self.label_ingredient_id = tk.Label(self.left_frame, font=('arial',12,'bold'),text="Ingredient ID: ",bd=7, anchor=tk.W,justify='left')
        self.label_ingredient_id.grid(row=0, column=0, sticky=tk.NW, padx=5)
        self.entry_ingredient_id = tk.Entry(self.left_frame, font=('arial',12),bd=5, width=35,justify='left')
        self.entry_ingredient_id.grid(row=0, column=1)

        self.label_ingredient_name = tk.Label(self.left_frame, font=('arial',12,'bold'),text="Ingredient Name: ",bd=7, anchor=tk.W,justify='left')
        self.label_ingredient_name.grid(row=1, column=0, sticky=tk.NW, padx=5)
        self.entry_ingredient_name = tk.Entry(self.left_frame, font=('arial',12),bd=5, width=35,justify='left')
        self.entry_ingredient_name.grid(row=1, column=1)

        self.label_ingredient_stock = tk.Label(self.left_frame, font=('arial',12,'bold'),text="Ingredient Stock: ",bd=7, anchor=tk.W,justify='left')
        self.label_ingredient_stock.grid(row=2, column=0, sticky=tk.NW, padx=5)
        self.entry_ingredient_stock = tk.Entry(self.left_frame, font=('arial',12),bd=5, width=35,justify='left')
        self.entry_ingredient_stock.grid(row=2, column=1)

        self.label_ingredient_minimun_stock = tk.Label(self.left_frame, font=('arial',12,'bold'),text="Minimum Stock: ",bd=7, anchor=tk.W,justify='left')
        self.label_ingredient_minimun_stock.grid(row=3, column=0, sticky=tk.NW, padx=5)
        self.entry_ingredient_minimun_stock = tk.Entry(self.left_frame, font=('arial',12),bd=5, width=35,justify='left')
        self.entry_ingredient_minimun_stock.grid(row=3, column=1)

        self.label_ingredient_unit = tk.Label(self.left_frame, font=('arial',12,'bold'),text="Unit Used: ",bd=7, anchor=tk.W,justify='left')
        self.label_ingredient_unit.grid(row=4, column=0, sticky=tk.NW, padx=5)
        self.entry_ingredient_unit = tk.Entry(self.left_frame, font=('arial',12),bd=5, width=35,justify='left')
    ...
    def menu_frame(self):
        ...
        self.load_button = tk.Button(self.menu_frame, text="Load", command=lambda: (self.forget(), self.load_data()))
...
class edit(tk.Frame):
    def __init__(self):
        ...
        self.title_text = tk.Label(self.title_frame, text="Edit Ingredients", pady=30, font=("Lucida Grande", 20, 'bold'))
        self.title_text.grid(columnspan=2)
