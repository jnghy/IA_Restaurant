...
class display(tk.Frame):
    def __init__(self):
        ...
        self.title_text = tk.Label(self.title_frame, text="Cost of Ingredients", pady=30, font=("Lucida Grande", 20, 'bold'))
    ...
    def navigation_frame(self):
        ...
        self.columns = ["ID", "Name","Total_Cost"]
    ...
    def display_frame(self):
        ...
        self.label_total_cost = tk.Label(self.left_frame, text="Total Cost: ", anchor=tk.W,justify='left')
        self.label_total_cost.grid(row=2, column=0, sticky=tk.NW, padx=5)
        self.entry_total_cost = tk.Entry(self.left_frame, width=35,justify='left')
        self.entry_total_cost.grid(row=2, column=1)

    def table_frame(self):
        self.fields = ["Id", "Name","Total Cost"]
        ...
        self.ingredient_table.column(self.fields[0], width=100)
        self.ingredient_table.column(self.fields[1], width=350)
    ...
    def focus_data(self, event):
        ...
        self.entry_total_cost.insert('end',ingredient_data[2])

    def load_data(self):
        data = database.select('''SELECT i.ingredient_id as "ID",  i.name as "Name", SUM(total_cost) as "Total_Cost"
                                FROM restocks r, ingredients i
